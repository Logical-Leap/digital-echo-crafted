...
import webDesignFaq from "@/data/webDesignFaq.json";
  ...
  return (
    <MainLayout>
            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  ...
                  <p>
                    We create custom websites that engage visitors and drive
                    conversions leading to sales for your business. From
                    responsive layouts to SEO-friendly builds, we focus on sites
                  ...
                  <div className="d-flex flex-wrap gap-3 align-items-center">
                    ...
                    <a
                      href="#web-design-faq-section"
                      onClick={(e) => {
                        e.preventDefault();
                        document
                          .getElementById("web-design-faq-section")
                          ?.scrollIntoView({ behavior: "smooth", block: "start" });
                      }}
                      className="explore-btn wow animate fadeInUp"
                      data-wow-delay="400ms"
                      data-wow-duration="800ms"
                      aria-label="See Web Design FAQs"
                      style={{
                        minHeight: "44px",
                        display: "inline-flex",
                        alignItems: "center",
      ...
      <ServiceFaq
        ...
        sectionTitle="Web Design FAQs"
        subtitle="Common questions about our web design process, pricing, and what's included. Can't find your answer? Get in touch for a free consultation."
        items={webDesignFaq}

      ...
      <div className="home1-banner-bottom mb-110">
        <Marquee>
          <div className="marquee_text">
            ...
            <h6>Welcome to Digital Kingsmen </h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={17}
              height={17}
            ...
            <h6>Empowering Your Vision for Greatness</h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={17}
              height={17}
            ...
            <h6>Thrive Digitally to Succeed Globally</h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={17}
              height={17}
            ...
            <h6>Achieve Extraordinary Results</h6>
            <br />
          </div>
        </Marquee>
      </div>

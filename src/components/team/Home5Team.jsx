          ...
          <div className="row">
            <div className="col-xxl-5 col-xl-4 d-flex flex-column gap-4 justify-content-between">
              ...
              >
                ...
                <p>
                  Discover the passionate individuals behind our success, each
                  bringing unique skills and a commitment to excellence.
                </p>
              </div>
            ...
            <div className="col-xxl-7 col-xl-8">
              <div className="row g-4">
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/team-01.png" alt="" />
                    ...
                    <div className="team-content text-center">
                      <h4>Jonah Tillman</h4>
                      <span>Founder | Digital Kingsmen</span>
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/team-02.png" alt="" />
                      <ul className="social-area">
                        <li>
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/team-03.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/team-04.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />
                        ...
                        <li>
                          <a href="https://www.linkedin.com/in/jonah-tillman/">
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/team-05.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/team-07.jpg" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/team-06.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />

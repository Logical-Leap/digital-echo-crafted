      ...
      <div className="home1-banner-section">
          ...
          <div className="row">
            <div className="col-lg-6 d-flex align-items-xxl-start align-items-center">
              <div className="banner-content">
                ...
                <h1>Web Design and Marketing for Growing Businesses.</h1>
                <p>
                  Digital Kingsmen offers elite web design and advanced
                  marketing strategies, empowering growing businesses to excel.
                  Elevate your brand and connect with customers effectively.
                </p>
                ...
                <div className="banner-content-bottom">
                  <Link
                    ...
                    data-text="Request a Digital Audit"
                  >
                    <span>Request a digital audit</span>
                  </Link>
                </div>
                <p
                  style={{
                ...
                >
                  *A{" "}
                  ...
                  assesses your online presence to help optimize strategies,
              ...
              <div className="banner-img-wrap">
                <Swiper {...settings} className="swiper banner-img-slider">
                  <div className="swiper-wrapper">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img src="assets/img/home1/banner-img2.png" alt="" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img src="assets/img/home1/banner-img3.png" alt="" />
                    </SwiperSlide>
                  </div>
                </Swiper>
              </div>
        ...
        <React.Fragment>
          <ModalVideo
            ...
            isOpen={isOpen}
            animationSpeed="350"
            url="/assets/video/production_.mp4"
            ratio="16:9"

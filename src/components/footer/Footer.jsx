        ...
        <div className="container">
            ...
            <div className="row align-items-center justify-content-center">
                ...
                <div className="footer-widget">
                  ...
                  <div className="menu-container">
                    <ul className="widget-list">
                      <li>
                        <Link href="/services#web-design-service">
                          Web Design
                        </Link>
                      </li>
                      <li>
                        <Link href="/services#marketing-service">
                          Digital Marketing
                        </Link>
                      </li>
                      <li>
                        <Link href="/services#analytics-service">
                          Analytics
                        </Link>
                      </li>
                    </ul>
                    <ul className="widget-list">
                      <li>
                        <Link href="/services#brand-development-service">
                          Brand Development
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link href="/services#consultation-services">
                          Consultations
                        </Link>
                      </li>
                    </ul>
              ...
              <div className="col-lg-4 col-md-6 d-flex justify-content-lg-center justify-content-md-end justify-content-sm-start">
                <div className="footer-logo-area">
                  ...
                  <div className="logo">
                    <img
                      src="/assets/img/footer-dark-logo.png"
                      alt=""
                      className="light"
                      style={{
                        width: "150px",
              ...
              >
                <div className="footer-widget">
                  ...
                  <div className="content">
                    <p>
                      At Digital Kingsmen, we combine innovative technology with
                      personalized strategies to deliver exceptional results for
                      local businesses. Our commitment to excellence and a deep
                      understanding of your unique needs ensure that we empower
                      your brand to thrive in a competitive market.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="contact-area">
            <div className="hotline-area">
              ...
              <div className="content">
                ...
                <h6>
                  <a href="tel:504-285-2241">+1 504-285-2241</a>
                </h6>
              </div>
            </div>
            <div className="hotline-area">
            ...
            <div className="hotline-area">
              ...
              <div className="content">
                <span>Say Hello</span>
                <h6>
                  <a href="mailto:info@digitalkingsmen.com">
          ...
          <div className="footer-bottom">
            <div className="copyright-area">
              <p>
                Copyright 2024 <a href="#">Digital Kingsmen</a>
              </p>
            </div>

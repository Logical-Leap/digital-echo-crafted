...
/**
 * Reusable service detail page. Mirrors the Web Design page layout so every
 * service has a consistent hero, feature list, process, contact, portfolio,
...
const ServicePageTemplate = ({
  ...
  description,
  features = [],
  image = "/assets/img/home3/project-management-tab-img1.png",
  ...
  return (
    <MainLayout>
      <div
        className="service-details-page mb-120 scroll-margin pt-120"
        ...
        <div className="container">
          <div className="service-details-top-area mb-80">
            <div className="row g-lg-4 gy-5 align-items-center">
              <div
                className="col-lg-6 order-lg-2 order-2 wow animate fadeInRight"
              ...
              <div
                className="col-lg-6 order-lg-1 order-1 wow animate fadeInLeft"
                data-wow-delay="150ms"
                data-wow-duration="800ms"
              >
                <div className="service-details-img">
                  <img src={image} alt={`${title} ${highlight || ""}`.trim()} />
                </div>
              </div>
            </div>
          </div>

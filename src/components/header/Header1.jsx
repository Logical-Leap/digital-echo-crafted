              ...
              <div className="sidebar-contact">
                  ...
                  <ul>
                    ...
                    <li className="single-contact">
                      ...
                      <div className="contact">
                        <span>Email Now</span>
                        <h6>
                          <a href="mailto:support@digitalkingsmen.com">
                            support@digitalkingsmen.com
                          </a>
                        </h6>
                      </div>
                    </li>
                ...
                <div className="social-link-area">
                  ...
                  <ul className="social-area">
                    <li>
                      <a href="https://x.com/digitalkingsmen">
                        <i className="bi bi-twitter-x" /> Twitter
                      </a>
                    </li>
                    <li>
                      <a href="https://www.linkedin.com/company/digital-kingsmen">
                        <i className="bi bi-linkedin" /> Linkedin
                      </a>
                    </li>
                    <li>
                      <a href=" https://www.instagram.com/digitalkingsmen/">
                        <i className="bi bi-instagram" /> Instagram
                      </a>
                    </li>
                    <li>
                      <a href="https://www.facebook.com/profile.php?id=61560874910304">
          ...
          <div className="company-logo">
            <Link href="/" className="logo-dark">
              <img
                ...
                className="img-fluid"
                src="assets/img/logo.png"
                style={{ width: "150px", height: "auto", maxWidth: "200px" }}
              />
            </Link>
            <Link href="/" className="logo-light">
              <img
            ...
            <div className="right-sidebar-and-hotline-area">
              <div className="hotline-area d-xl-flex d-none">
                ...
                <div className="content">
                  ...
                  <h6>
                    <Link href="tel:504-285-2241">504-285-2241</Link>
                  </h6>
                </div>
              </div>

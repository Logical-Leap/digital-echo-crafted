...
const Home2Contact = () => {
  return (
    <>
      <div
        id="free-audit"
        className="home2-contact-section"
        style={{ paddingTop: "120px", marginTop: "110px" }}
      >
            ...
            <div className="col-lg-6">
              <div className="contact-content">
                ...
                >
                  ...
                  <p>
                    Discover where your business is at and how we can improve
              ...
              <div className="contact-form-wrap">
                <div className="contact-form-area">
                  ...
                  <iframe
                    ...
                    id="inline-KH3kxkPtzOq7ffgUC2Fh"
                    ...
                    data-height="450"
                    data-layout-iframe-id="inline-KH3kxkPtzOq7ffgUC2Fh"
                    data-form-id="KH3kxkPtzOq7ffgUC2Fh"
                    title="Free Website Audit"
                  ></iframe>
                  <script src="https://link.digitalkingsmen.com/js/form_embed.js"></script>
                </div>
              </div>
            </div>
          </div>
